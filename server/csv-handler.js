...
module.exports.csv_writer = async function (path_to_csv_file, csv_headers, array_of_objects)  {
    ...
    await csvWriter.writeRecords(array_of_objects).then(() => console.log(`${newLineChar}The data was written successfully to: ${path_to_csv_file}`));

    fs.writeFile(path_to_csv_file, "\uFEFF" + fs.readFileSync(path_to_csv_file, "utf8"), function (error) {
